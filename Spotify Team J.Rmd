...
playlist_genre.labs <- genre_labels$label
names(playlist_genre.labs) <- genre_labels$playlist_genre #is this base R
...
spotify_songs$danceability = min_max_norm(spotify_songs$danceability)
spotify_songs$energy = min_max_norm(spotify_songs$energy)
spotify_songs$loudness = min_max_norm(spotify_songs$loudness)
spotify_songs$speechiness = min_max_norm(spotify_songs$speechiness)
spotify_songs$acousticness = min_max_norm(spotify_songs$acousticness)
spotify_songs$instrumentalness = min_max_norm(spotify_songs$instrumentalness)
spotify_songs$liveness = min_max_norm(spotify_songs$valence)
spotify_songs$tempo = min_max_norm(spotify_songs$tempo)
spotify_songs$valence = min_max_norm(spotify_songs$valence)
spotify_songs$duration_ms = min_max_norm(spotify_songs$duration_ms)
spotify_songs$key = min_max_norm(spotify_songs$key)
